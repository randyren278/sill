...
export const SPECIES: Species[] = [
  ...
  { common: 'Hydrangea',   latin: 'Hydrangea macrophylla', arch: 'bush', greens: 'bright', size: 'sm', light: 'Bright indirect', freq: 3,  fact: "Its name comes from the Greek 'hydor' (water) and 'angeion' (vessel) — a reminder it drinks more than most houseplants." },
