...
export const sprites: Record<string, string[]> = {
  ...
  'bush-xs': ['                  ', '        PP        ', '       pPPp       ', '      DLHLLD      ', '       DGLD       ', '        SS        ', '        SS        ', '   wWWWWWWWWWWw   ', '   wWWWRSSRWWWw   ', '   wWWRRWWRRWWw   ', '   wWRRWWWWRRWw   ', '   wWWRWWWWRWWw   ', '   wWWWRWWRWWWw   ', '   wWWWWWWWWWWw   ', '   wWWWWWWWWWWw   ', '   wWWWWWWWWWWw   ', '    wwwwwwwwww    ', '                  '],
